...
Cloud storage systems (S3, ADLS, GCS) provide atomic file creation, and Delta Lake leverages
...
storage system. When you write to S3, ADLS, or GCS, those systems replicate your data across
...
3. **Cloud storage doesn't support locks**: S3, ADLS, and GCS don't have native locking mechanisms.
...
DURABILITY:
  - Pipeline A's commit (version 11 JSON file) is written to S3/ADLS
  - S3/ADLS replicates across availability zones
